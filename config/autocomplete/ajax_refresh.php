<?php
// PDO connect *********
define ('DBUSER', 'ninechapter');
define ('DBPASS','bigdata');
define ('DBNAME','ninechapter');

function connect() {
    return new PDO('mysql:host=localhost;dbname=ninechapter', 'ninechapter', 'bigdata', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION, PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
}
